    ...
    <body>
        <div class="header">
            ...
            <div class="header-right">
                ...
                <a  class="active" href="Owner_ViewMyAd.jsp">View My Ads</a>
        ...
        <div class ="signupbox">
            ...
            <div class="table">
                <table>
                    ...
                    <tr>
                        <td>   
                            <img src="45.png" alt="" width="150px" height="150px"/>
                        </td>
                        <td>Furniture </td>
                        <td>Kitchen Stools </td>
                        <td>Rs.1000 per day </td>
                        <td>Available </td>

                        <td> <a href ="${acclink} " name = "delete"> Delete </a> </td>
                    </tr>
