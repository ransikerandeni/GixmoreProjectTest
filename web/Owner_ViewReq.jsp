        ...
        <div class="header">
            ...
            <div class="header-right">
                  <a  href= "index.jsp">Logout</a>
                    ...
                    <a class="active" href="Owner_ViewReq.jsp">View Requests</a>
            ...
            <div class="table">
                <table>
                    ...
                    <tr>
                        ...
                        <td> <a href ="${accLink} " name = "accept"> Accept </a> </td>
                            <td> <a href ="${rejLink} " name = "reject"> Reject </a> </td>
                    </tr>
